...
app.config['SECRET_KEY'] ='528de1481491180ffdd6f73e'
db = SQLAlchemy(app)
bcrypt = Bcrypt(app)
...
#hiding direct letters of password
@property
...
#GIVES CREATE ACCOUNT BUTTTON POWER TO VALIDATE ONLY IF THEFORM IS SUBMITTED
